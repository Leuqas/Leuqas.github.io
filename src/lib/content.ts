export const profile = {
  ...
  messenger: "https://www.facebook.com/leuqas/",
...
export const services = [
  {
    ...
    description:
      "Custom business websites for cafes, clinics, shops, and service businesses that need online visibility and clear calls to action.",
  },
  {
    title: "Custom Systems",
    description:
      "Reservation flows, scheduling tools, admin dashboards, and other systems tailored to your exact business process.",
  },
  {
    title: "Maintenance & Monthly Support",
    description:
      "Continuous updates, bug fixes, and practical improvements so your system keeps working as your business grows.",
  },
];
