          ...
          <span className="flex items-start gap-4">
            ...
            <span>
              <span className="block font-semibold">
                Legacy Responsive Web Design · Feb 2022
              </span>
              <span className="mt-1 block text-sm text-muted-foreground">
                <span ><a className="text-emerald-600">300 hours</a> of coursework completed at <b className="text-emerald-600">12 years old</b></span>
              </span>
